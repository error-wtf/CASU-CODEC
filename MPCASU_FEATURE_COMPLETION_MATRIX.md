...
| Subtitle/chapter selection | libVLC plus native text/libass/bitmap/chapter path | dynamic controls + clickable bounded timeline markers | real libVLC external/embedded selection + native RGBA/text/chapter/seek tests | PASS reference matrix |
