...
| URL playback | libVLC locations without scheme allow-list; false empty EOF normalized | real URL dialog | loopback HTTP redirect + PCM playback/seek + 404 error + HLS AAC-in-TS playback/seek | PARTIAL HTTPS/auth/mutable-live/hostile-network matrix |
