...
- Steps 41–50: PARTIAL — independent native video/PCM/subtitle/chapter paths,
  ...
  generations and reopens Pulse for changed PCM geometry. Transient sink-error
  cleanup and same-container replay pass. A 21,600-block/six-hour variable-
  latency simulation has zero accumulation drift. Bounded PipeWire sink
  inventory/default fallback and transactional device switching pass;
  pitch-preserving time-stretch, real-device master-clock evidence, physical
  hotplug and long drift remain.
...
- Steps 57–60: PARTIAL — the generated exact-runtime libVLC matrix now proves
  ...
  rate/delay/pause/resume pass. Dummy-sink volume is not physical-volume proof.
