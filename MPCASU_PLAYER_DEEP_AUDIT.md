...
| Native subtitles/chapters | PASS reference matrix | UTF-8 packets, ASS/SSA libass RGBA with bounded embedded fonts, and typed alpha-bounded PGS/DVD/DVB/XSub RGBA render/clear/seek; native and real two-chapter libVLC MP4 seek work. |
...
17 passes/9 runtime XFAILs (including real FLAC rate/delay/pause/resume,
pixel-distinct paused Rawvideo single-frame stepping and HTTP HLS-AAC seek),
