...
> **Version:** `1.0.0` — see [RELEASE_GATE_STATUS.json](RELEASE_GATE_STATUS.json).
...
sudo dpkg -i casu-codec_1.0.0_all.deb \
             casu-converter_1.0.0_all.deb \
             mpcasu_1.0.0_all.deb \
             web-casu_1.0.0_all.deb
