...
| Field | Value |
|-------|-------|
| Current phase | **PHASE A–D VERIFIED; Web-Provider-Tabs (QtWebEngine) + setup.exe ergänzt; STEP-042 Abschluss offen** |
| Current execution step | **Web-Player-Tabs (eingebetteter QtWebEngine-Browser) + setup.exe umgesetzt** — als nächstes: STEP-042 Abschluss + optionaler MSVC/QtWebEngine-Endbuild auf Windows |
...
| Phase C Converter | CASU-Converter.exe (Qt-GUI) implementiert; casu_converter_test + casu_converter_engine_test **ALL PASS unter Wine**; Fenster-Screenshots in test-results/wine/ |
